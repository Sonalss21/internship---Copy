	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Project One</h1>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							...
							<div class="team-member text-center">
								<img src="img/deep.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Name 1</h4>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												Project One is an online E-learning website <br>
